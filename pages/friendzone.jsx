    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>A FriendZone App</h2>
          <h3>React JS / Node JS / Chakra-UI</h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            are able to login , signup, create a post , follow other users .
            User can also edit their profile .
          </p>
          <a
            href='https://github.com/amitmishra7488/friendzone-frontend'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://my-friendzone.netlify.app/'
            target='_blank'
            rel='noreferrer'
          >
