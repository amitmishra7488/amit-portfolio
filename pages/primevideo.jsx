    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>PrimeVideo App</h2>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            This app features user authentication . This application is pulling movie
            data from an the IMDB movie API and displaying different categories.
            It features horizontal sliding and a featured selection. 
          </p>
          <a
            href='https://github.com/amitmishra7488/prime_video_clone'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://amazon-prime-replica.netlify.app'
            target='_blank'
            rel='noreferrer'
          >
